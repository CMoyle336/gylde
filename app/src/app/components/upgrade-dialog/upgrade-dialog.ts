...
> = {
  ...
  canAccessPrivateContent: {
    titleKey: 'UPGRADE_DIALOG.FEATURE_MESSAGES.CAN_ACCESS_PRIVATE_CONTENT.TITLE',
    descriptionKey: 'UPGRADE_DIALOG.FEATURE_MESSAGES.CAN_ACCESS_PRIVATE_CONTENT.DESCRIPTION',
    icon: 'lock_open',
  },
  advancedFilters: {
